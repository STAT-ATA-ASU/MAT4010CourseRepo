...
To test your package use either `Ctrl/Cmd-Shift-T` or `devtools::test()`.  For more guidance, see the Testing chapter of [R Packges](http://r-pkgs.had.co.nz/tests.html).
