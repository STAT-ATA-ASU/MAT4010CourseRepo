...
* Disucss chapters five and six of _R Packages_
...
* Documenting S3 Classes, Generics, and Methods
* Make sure Travis-CI is passing
* Work on Group packages - (Individual assignments to follow)
* Push indiviudal notes from chapters 1-7 (one document) to your private repositories before leaving on Spring Break.  
