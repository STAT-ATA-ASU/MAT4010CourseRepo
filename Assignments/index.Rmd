...
* Read pages 1-37 of _Hands-On Programming with R_.  Create an `Rscripts` folder inside your private repository and store all code in the `Rscripts`  folder for `Project 1`.
